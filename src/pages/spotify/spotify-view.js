...
// Styled imports
import { StyledColumn, StyledRow, StyledButton } from "./spotify-style";
...
const SpotifyPage = () => {
  ...
  return (
    <>
      ...
      <BackButton />
      <StyledButton onClick={() => {window.location.href = spotifyUrl}}>Connect to your Spotify</StyledButton>
    </>
  );
};
